# Thrushcombe St Mary — portrait prompts

Image-generation prompts for every soul's sepia portrait. **Prepend the shared STYLE block to
each person's line.** Save each result as the person's index (`18.jpg`) **or** their name-slug
(`major-pringle.jpg`) in `portraits/` — the web server's `resolve_portrait` accepts either, any
image format. They appear on `/folk/<n>`, as little faces on the map, and as Discord avatars.

There's also a separate **map** prompt at the bottom (save as `portraits/map.jpg`).

**Progress:** ✅ = portrait done and in `portraits/`. 51 of 63 sitters photographed so far.

---

## STYLE — prepend to every prompt

> *A 1934 sepia studio portrait photograph, rural West-Country England. Authentic period
> photography — soft silver-gelatin sepia tones, fine grain, slight vignette, plain muted studio
> backdrop. Head-and-shoulders, the sitter looking just off-camera. A real, unglamorous period
> face; period-accurate clothing, hair and grooming. Honest and dignified, of its time. No modern
> elements, no colour, no text, no border.*
...
- ✅ **[25] Mrs Toms (Cook)** — a 45-year-old cook of 31 years' service; forearms mapped with old scalds and burns, an apron and cap, unselfconscious kitchen authority.
- ✅ **[26] Gladys** — a 19-year-old scullery maid; thin, hands raw from the lye, a plain dress and apron, kept small and useful, watchful.
...
- ✅ **[2] Robin Pelham** — a well-mannered solicitor's son of 11, neat Sunday clothes, a serious look.
- ✅ **[3] Vicky Pelham** — a solicitor's daughter of 8, ribboned hair, a clean pinafore.
- **[46] Sam Pelham** — a solicitor's boy of 5, round-faced, a little stiff for the camera.
- **[47] Tom Soames** — the vicar's son, 13, scrubbed and proper, a buttoned collar.
- **[48] Milly Soames** — the vicar's daughter, 9, plaited hair, a Sunday frock.
- **[49] Tilly Sunter** — a hill-farm girl of 14, hardy, plainly dressed, weather-cheeked.
- **[50] Ned Sunter** — a hill-farm boy of 10, tousled, a hand-knitted jersey.
- **[51] Annie Metcalfe** — a fell-farm girl of 13, weather-cheeked, a hand-me-down dress.
- **[52] Georgie Metcalfe** — a fell-farm boy of 8, gap-toothed, mud-knees in his Sunday best.
- **[57] Dora Metcalfe** — a fell-farm girl of 5, small and shy, plaited hair.
- **[53] Rose Pringle** — a genteel daughter of 15, ribboned hair, a good frock, poised.
- **[54] Phoebe Pringle** — a genteel daughter of 11, neat, bright-eyed.
- **[55] Bertie Bunce** — a publican's boy of 12, lively, a cap and a cheeky grin held in check for the photographer.
- **[56] Lottie Bunce** — a publican's girl of 7, gap-toothed smile, a clean pinafore.

---

## The map — `portraits/map.jpg`

> *A 1934 hand-drawn bird's-eye pictorial map of an English West-Country market town,
> "Thrushcombe St Mary", in the style of a period estate map or a charming illustrated village
> plan — sepia and soft watercolour washes, fine pen linework, a decorative compass rose and a
> title cartouche. A river/beck winding through, a stone church (St Mary's) with a square tower at
> the centre, a market square, a high street with little shops, an inn (The Pelican), a forge, a
> mill on the beck, a railway station and line at the edge, scattered farmsteads on the hills, hedged
> fields and lanes. Labelled buildings in period hand-lettering. Warm, inviting, lightly worn paper.
> No modern elements, no cars, no people — just the town laid out as if drawn between the wars.*
